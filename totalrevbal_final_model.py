...
dataset = pd.read_csv("C:/Users/mona/Desktop/DATA SCIENCE/DS Project/Data.csv", encoding='latin1' )
...
#prd_validation = pd.DataFrame(prd_V, columns=['total revol_bal']).to_csv('Kaggle_validation.csv')
